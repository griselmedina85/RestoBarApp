...
namespace webapi.Migrations
{
    ...
    [Migration("20230406170259_initialGrisel")]
    partial class initialGrisel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webapi.Models.ReservationEntity", b =>
                {
                    ...
                    b.Property<int?>("RestaurantEntityRestaurantId")
                        .HasColumnType("int");

                    b.Property<int>("RestaurantId")
                        .HasColumnType("int");

                    b.Property<int?>("TableEntityTableId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("webapi.Models.TableEntity", b =>
                {
                    ...
                    b.Property<int?>("LocationEntityLocationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LocationEntityLocationId");
            ...
            modelBuilder.Entity("webapi.Models.ReservationEntity", b =>
                {
                    b.HasOne("webapi.Models.ClientEntity", null)
                        .WithMany("Reservations")
                        .HasForeignKey("ClientEntityClientId");

                    b.HasOne("webapi.Models.RestaurantEntity", null)
                        .WithMany("Reservations")
                        .HasForeignKey("RestaurantEntityRestaurantId");

                    b.HasOne("webapi.Models.TableEntity", null)
                        .WithMany("Reservations")
                        .HasForeignKey("TableEntityTableId");
                });

            modelBuilder.Entity("webapi.Models.TableEntity", b =>
                {
                    b.HasOne("webapi.Models.LocationEntity", null)
                        .WithMany("Tables")
                        .HasForeignKey("LocationEntityLocationId");
